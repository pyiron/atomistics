...
class TestElastic(unittest.TestCase):
    def test_calc_elastic(self):
        ...
        self.assertTrue(np.isclose(elastic_dict["C"][0, 0], 53.33436324))
        self.assertTrue(np.isclose(elastic_dict["C"][0, 1], 32.85853415))
        self.assertTrue(np.isclose(elastic_dict["C"][3, 3], 36.19530571))
