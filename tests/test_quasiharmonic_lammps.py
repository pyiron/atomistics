...
class TestPhonons(unittest.TestCase):
    def test_calc_phonons(self):
        ...
        self.assertTrue(tp_collect_dict["free_energy"][0] > 0.0)
        self.assertTrue(tp_collect_dict["free_energy"][0] < 0.1)
        self.assertTrue(tp_collect_dict["free_energy"][-1] < 0.0)
        self.assertTrue(tp_collect_dict["free_energy"][-1] > -0.1)
        self.assertTrue(tp_collect_dict["entropy"][0] < 0.1)
        self.assertTrue(tp_collect_dict["entropy"][0] > 0.0)
        self.assertTrue(tp_collect_dict["entropy"][-1] < 10)
        self.assertTrue(tp_collect_dict["entropy"][-1] > 9)
        self.assertTrue(tp_collect_dict["heat_capacity"][0] < 0.1)
        self.assertTrue(tp_collect_dict["heat_capacity"][0] > 0.0)
        self.assertTrue(tp_collect_dict["heat_capacity"][-1] < 4)
        self.assertTrue(tp_collect_dict["heat_capacity"][-1] > 3.6)
