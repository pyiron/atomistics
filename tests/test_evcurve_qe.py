...
class TestEvCurve(unittest.TestCase):
    def test_calc_evcurve(self):
        ...
        print(fit_dict)
        self.assertTrue(np.isclose(fit_dict['volume_eq'], 70.89477657207699, atol=1e-04))
        self.assertTrue(np.isclose(fit_dict['bulkmodul_eq'], 52.69607220079356, atol=1e-04))
        self.assertTrue(np.isclose(fit_dict['b_prime_eq'], 3.396684968675607, atol=1e-04))
