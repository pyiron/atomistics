...
from pyiron_lammps.state.singleton import Singleton
...
class Settings(metaclass=Singleton):
    """The unique state object (singleton) for the currently running pyiron instance.

    The state object reads configuration data from the following sources in decreasing order of priority: system
