...
class QuasiHarmonicThermalProperties(object):
    ...
    def free_energy(self) -> np.ndarray:
        ...
        """
        return self.get_property("free_energy")
...
def generate_structures_helper(
    ...
    Args:
        structure (Atoms): The structure.
        vol_range (float, optional): The volume range. Defaults to None.
        num_points (int, optional): The number of points. Defaults to None.
        strain_lst (List[float], optional): The list of strains. Defaults to None.
        ...
        factor (float, optional): The factor. Defaults to VaspToTHz.
    """
